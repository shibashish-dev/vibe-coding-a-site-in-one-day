...
$classes = Flux::classes()
    ...
    ->add($square ? '' : 'px-2.5!')
    ->add('text-black dark:text-white/80 ')
...
<flux:button-or-link :attributes="$attributes->class($classes)" data-flux-navbar-items>
    ...
    <?php if ($slot->isNotEmpty()): ?>
        <div class="{{ $icon ? 'ms-3' : '' }} flex-1 text-sm leading-none whitespace-nowrap [[data-nav-footer]_&]:hidden [[data-nav-sidebar]_[data-nav-footer]_&]:block" data-content>{{ $slot }}</div>
    <?php endif; ?>
